<template>
  <div class="support">
    <ee-titlebar>Support Us</ee-titlebar>
    <ee-text type="block">
    ...
    <ee-text type="block">
      Donations can contribute to a variety of matters including but not limited to:
